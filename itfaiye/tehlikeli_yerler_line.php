<?php
	...
	$sql = "SELECT * FROM `tehlikeli_yerler` ";
...
<br>
  <div class="conn" style="width:900px;">
   <h2 align="center">İZMİR İLİ TEHLİKELİ YERLER VERİSİ</h2><hr> <br>
   <input class="btn" type="submit" name="cizgi" value="Çizgi" onclick="window.location='tehlikeli_yerler.php';" />
   <input class="btn" type="submit" name="sutun" value="Sütun" onclick="window.location='tehlikeli_yerler_line.php';" />
   <input class="btn" type="submit" name="tablo" value="Tablo" onclick="window.location='tehlikeli_yerler_table.php';" />
   ...
   <br><br><br>
   	    ...
   	    <div class="container">	      
			<canvas id="chart" style="width: 100%; height: 75vh;  color: #000; margin-top: 10px; margin-left: -10px;"></canvas>
			...
			<script>
        		...
        		type: 'bar',
		        data: {
		            labels: ['Tüpraş','Heper Metal Döküm San. Ve Tic. A.Ş.','Habaş','TPI Kompozit Kanat Sanayi Ticaret A.Ş','Geo-Mak','Polidaş Polietilen Mamülleri Kim. San. Tic. Ltd.','Savranoğlu Deri San. A.Ş.','Caran Kimya'],
		            datasets: 
		            [{
		            	label: 'İlçe ID',
		                data: [<?php echo $data1; ?>],
