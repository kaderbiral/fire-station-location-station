...
<br>
  <div class="conn" style="width:900px;">
   <h2 align="center">İZMİR İLİ DEPREM RİSKİ YÜKSEK YERLER VERİSİ</h2><hr> <br>
   <input class="btn" type="submit" name="cizgi" value="Çizgi" onclick="window.location='deprem_riski.php';" />
   <input class="btn" type="submit" name="sutun" value="Sütun" onclick="window.location='deprem_riski_line.php';" />
   <input class="btn" type="submit" name="tablo" value="Tablo" onclick="window.location='deprem_riski_table.php';" />
   ...
   <br><br><br>
   	    ...
   	    <div class="container">	      
			<canvas id="chart" style="width: 100%; height: 55vh;  color: #000; margin-top: 10px; margin-left: -10px;"></canvas>
			...
			<script>
        		...
        		type: 'bar',
		        data: {
		            labels: ['Karabağlar','Menemen','Narlıdere','Buca','Karşıyaka','Kemalpaşa','Bayındır','Torbalı','Konak','Gaziemir','Bayraklı','Çiğli'],
		            datasets: 
		            [{
		            	label: 'İlçe ID',
		                data: [<?php echo $data1; ?>],
