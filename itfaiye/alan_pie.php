<?php  
 ...
 $query = "SELECT ilce_adi, alan_km2 FROM nufus WHERE nufus.alan_km2>500";  
	...
	<script type="text/javascript">  
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ...
                          {  
                               echo "['".$row["ilce_adi"]."', ".$row["alan_km2"]."],";  
                          }  
                          ?>  
                     ]);  
                var options = {  
                      title: "Alanı 500 km²'den Fazla Olan İlçeler",  
                      is3D:true,  
                      //pieHole: 0.4  
                     };  
...
<br>
  <div class="conn" style="width:900px;">
   <h2 align="center">İZMİR İLİ ALAN VERİSİ</h2><hr> <br>
