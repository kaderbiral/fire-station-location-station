...
$bilgi=mysqli_query($con,"select * from yol");
echo '<table class="tablo" style="margin-left:0px; margin-bottom:50px;" border="1" cellpadding="10" cellspacing="3">
	<tr>
		<td width="200" bgcolor="#E7E7E7"><b>YOL ID</b></td>
		<td width="200" bgcolor="#E7E7E7"><b>İLÇE ADI</b></td>
		<td width="600" bgcolor="#E7E7E7"><b>YOL ADI</b></td>
		<td width="200" bgcolor="#E7E7E7"><b>İLÇE ID</b></td>
		<td width="160" bgcolor="#E7E7E7"><b>İSTASYON ID</b></td>
	</tr>';
