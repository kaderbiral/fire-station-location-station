...
echo '<table class="tablo"  border="1" cellpadding="10" cellspacing="3">
	<tr>
		...
		<td width="300" bgcolor="#E7E7E7"><b>İLÇE ADI</b></td>
		<td width="300" bgcolor="#E7E7E7"><b>ALAN (km²)</b></td>
		<td width="300" bgcolor="#E7E7E7"><b>NÜFUS</b></td>
		<td width="300" bgcolor="#E7E7E7"><b>ALDIĞI GÖÇ ORANI (‰)</b></td>
	</tr>';
...
{echo '	<tr>
		...
		<td>'.$cek["ilce_adi"].'</td>
		<td>'.$cek["alan_km2"].'</td>
		<td>'.$cek["nufus_orani"].'</td>
		<td>'.$cek["aldigi_goc_orani"].'</td>
	</tr>';}
echo '</table>';
?>
