...
$bilgi=mysqli_query($con,"select * from istasyon");
echo '<table class="tablo" style="margin-left:0px; margin-bottom:50px;" border="1" cellpadding="10" cellspacing="3">
	<tr>
		...
		<td width="300" bgcolor="#E7E7E7"><b>İSTASYON ADI</b></td>
		<td width="800" bgcolor="#E7E7E7"><b>ADRES</b></td>
