...
$bilgi=mysqli_query($con,"select * from deprem_riski");
echo '<table class="tablo" style="margin-left:0px; margin-bottom:50px;" border="1" cellpadding="10" cellspacing="3">
	<tr>
		<td width="300" bgcolor="#E7E7E7"><b>DEPREM ID</b></td>
		<td width="700" bgcolor="#E7E7E7"><b>İLÇE ADI</b></td>
		<td width="300" bgcolor="#E7E7E7"><b>İLÇE ID</b></td>
		<td width="230" bgcolor="#E7E7E7"><b>YOL ID</b></td>
		<td width="300" bgcolor="#E7E7E7"><b>İSTASYON ID</b></td>
	</tr>';
