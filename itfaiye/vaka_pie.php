<?php  
 ...
 $query = "SELECT cagri_nedeni, count(*) as number FROM vakalar GROUP BY cagri_nedeni"; 
	...
	<script type="text/javascript">  
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ...
                          {  
                               echo "['".$row["cagri_nedeni"]."', ".$row["number"]."],";  
                          }  
                          ?>  
                     ]);  
                var options = {  
                      title: "Türlerine Göre Gerçekleşen Olayların Sayısı",  
                      is3D:true,  
                      //pieHole: 0.4  
                     };  
...
<br>
  <div class="conn" style="width:900px;">
   <h2 align="center">İZMİR İLİ VAKA VERİSİ</h2><hr> <br>
