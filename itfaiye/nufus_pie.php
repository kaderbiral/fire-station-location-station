<?php  
 ...
 $query = "SELECT ilce_adi, nufus_orani FROM nufus WHERE nufus.nufus_orani>150";  
	...
	<script type="text/javascript">  
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ...
                          {  
                               echo "['".$row["ilce_adi"]."', ".$row["nufus_orani"]."],";  
                          }  
                          ?>  
                     ]);  
                var options = {  
                      title: "Nüfus Oranı 150.000'den Yüksek Olan İlçeler",  
                      is3D:true,  
                      //pieHole: 0.4  
                     };  
...
<br>
  <div class="conn" style="width:900px;">
   <h2 align="center">İZMİR İLİ NÜFUS VERİSİ</h2><hr> <br>
