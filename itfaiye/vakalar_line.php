<?php
	...
	while ($row = mysqli_fetch_array($result)) {
		...
		$data1 = $data1 . '"'. $row['olay_yerine_ulasim_suresi_dk'] .'",';
...
<br>
  <div class="conn" style="width:900px;">
   ...
   <br><br><br>
   	    ...
   	    <div class="container">	      
			<canvas id="chart" style="width: 100%; height: 55vh;  color: #000; margin-top: 10px; margin-left: -8px;"></canvas>
			...
			<script>
        		...
        		type: 'bar',
		        data: {
		            labels: ['Orman yangını','İntihar girişimi','Asansörde sıkışma','Hayvan kurtarma','Bina yangını','Araç yangını','Fabrika yangını'],
		            datasets: 
		            [{
		            	label: 'Olay yerine ulaşım süresi (dk)',
		                data: [<?php echo $data1; ?>],
